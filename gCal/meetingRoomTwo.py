...
def main():
    ...
    calId = '0n3b8ud375peurvjesd41rm29g@group.calendar.google.com'
    ...
    if not nowEvents:
        f = open("/vagrant/html/two/meetingRoomTwoName", "w")
        f.write("None")
        f.close()
        f = open("/vagrant/html/two/meetingRoomTwoTime", "w")
        f.write("Vacant")
        f.close()
        f = open("/vagrant/html/two/meetingRoomTwoAgenda", "w")
        ...
        if nextEvents:
            ...
            print('Now Vacant')
            f = open("/vagrant/html/two/meetingRoomTwoNextName", "w")
            f.write(nextEvent['description'])
            f.close()
            f = open("/vagrant/html/two/meetingRoomTwoNextTime", "w")
            f.write(startTime + ' ~ ' + endTime)
            f.close()
            f = open("/vagrant/html/two/meetingRoomTwoNextAgenda", "w")
